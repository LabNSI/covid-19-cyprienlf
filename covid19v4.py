...
if __name__ == '__main__':
    ...
    if download_file(url,file):
        ...
        allemagne = data_for_country(countries, '', 'Germany')
        suede = data_for_country(countries, '', 'Sweden')
        espagne = data_for_country(countries, '', 'Spain')
        ...
        x , y = trace_data_for_country(allemagne)
        plt.plot(x, y, label="Allemagne")

        x , y = trace_data_for_country(suede)
        plt.plot(x, y, label="Suede")

        x , y = trace_data_for_country(espagne)
        plt.plot(x, y, label="Espagne")
